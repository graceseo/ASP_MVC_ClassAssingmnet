...
{
    public class GraceMembersController : Controller
    {
        private readonly SailContext _context;

        public GraceMembersController(SailContext context)
        {
            _context = context;
        }
        ...
        {
            //Add 'Orderby' to order the listing by Fullname --Grace
