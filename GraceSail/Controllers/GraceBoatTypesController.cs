 ...
 * Date: Oct 24, 2018
 * Purpose: a controller for CRUD to a Boat Types table
 */
using System;
...
{
    public class GraceBoatTypesController : Controller
    {
        private readonly SailContext _context;

        public GraceBoatTypesController(SailContext context)
        {
            _context = context;
        }
        ...
        // GET: GraceBoatTypes/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: GraceBoatTypes/Create
